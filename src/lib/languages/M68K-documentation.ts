import { M68kInstructions } from "./M68K-language";
...
const desc = {
    ...
    "bcc": "Branches to the specified address if {} is true",
    "scc": "Sets the destination operand to 0 if {} is true, otherwise it sets it to -1",
    ...
    "lsd": "Shifts the bits of the second operand as many times as the value of the first operand, depending on the specified size. The new bits are filled with 0s. Defaults to word",
    "asd": "Shifts the bits of the second operand as many times as the value of the first operand, depending on the specified size. The new bits are filled with the sign bit. Defaults to word",
    "rod": "Rotates the bits of the second operand as many times as the value of the first operand, depending on the specified size. Defaults to word",
