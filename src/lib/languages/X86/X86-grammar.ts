...
export const X86Directives = [
    ...
    '%xdefine',
    '%assign',
    '%iassign', // Preprocessor defines (NASM)
    '%undef',
    '%ifdef',
    '%ifndef',
    '%elifdef',
    '%elifndef',
    '%else',
    '%endif', // Preprocessor conditional (NASM)
    '%if',
    '%elif',
    '%ifidn',
    '%ifidni',
    '%ifmacro',
    '%ifnum',
    '%ifstr', // Preprocessor conditional (NASM)
    '%error',
    '%warning',
    '%fatal', // Preprocessor messages (NASM)
    '%include',
    '%pathsearch',
    '%depend',
    '%use', // Preprocessor include/use (NASM)
    '%push',
    '%pop',
    '%repl', // Preprocessor context (NASM)
    '%arg',
    '%stacksize',
    '%local', // Preprocessor macro related (NASM)
    'proc',
    'endp', // Procedures (MASM style)
