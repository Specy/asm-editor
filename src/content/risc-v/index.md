This course is about one architecture, RISC-V, and about writing programs for it in the editor you
are reading this in.
...
takes all of that for granted and goes over the same topics again in more depth, in RISC-V only.
