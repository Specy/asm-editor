...
```mips|playground|screen|console|no-registers
.eqv MMIO 0xffff0000
.data
...
```mips|playground|screen|memory|exercise
# @screen unit=16 width=256 height=256 base=display
.eqv SIDE 16
.data
display: .space 1024
...
```mips|playground|screen|memory|solution
# @screen unit=16 width=256 height=256 base=display
.eqv SIDE 16
.data
display: .space 1024
