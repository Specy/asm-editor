<script lang="ts">
    ...
    import { z80InstructionNames } from '$lib/languages/Z80/Z80-documentation'
    ...
    const instructions = Array.from(z80InstructionNames)
        ...
        {#if group.instructions.length}
            ...
            <div class="instructions">
                {#each group.instructions as ins (ins)}
                    <a
                        class="instruction"
                        href={resolve('/documentation/z80/instruction/[instructionName]', {
                            instructionName: ins
                        })}
                    >
                        <div>
