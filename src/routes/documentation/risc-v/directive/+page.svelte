...
<svelte:head>
    <title>RISC-V Directives</title>
    <meta
        name="description"
        content="RISC-V directives are used by the assembler to execute operations at assembly time. Learn how to use them and the available directives."
    />
    <meta
