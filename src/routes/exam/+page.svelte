...
<Page contentStyle={'padding-top: 3.5rem;'}>
    <Row gap="1rem" flex1 wrap>
        <Column gap="1rem" padding="0.6rem 1rem;" flex1>
            ...
            <Row align="center" justify="between" gap="1rem">
                <Header type="h2">Exam access Password</Header>
                <Input
                    type="text"
            ...
            <Row align="center" justify="between" gap="1rem">
                <Header type="h2">Exam unlock Password</Header>
                <Input
                    type="text"
        ...
        <Column style={'padding: 0.5rem; flex:1'} gap="1rem">
            ...
            {/key}
            <Row>
                <Button onClick={createExamUrl} hasIcon style="gap: 0.5rem; padding: 0.6rem 1rem;">
                    <Icon>
                        <FaDumbbell />
                    </Icon>
                    Create exam
