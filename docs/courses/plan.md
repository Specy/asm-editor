...
| D   | Retire `src/content/examples`; redirect `/learn/courses/examples` and its three lectures to the new pages (in the `[courseId]` layout load)                                                                                                                                                                                                         | routes                                                                   | last batch (Z80), once every ladder has its `factorial-and-fibonacci` page to redirect to |
...
- No Core delivers a device interrupt (the MARS keyboard's interrupt-enable bit stops the program, EASy68K's
