...
- The panel shows one file at a time behind tabs, and each file offers the **Formats** that make sense for its registers (below). Both choices are session state, like today's B/W/L/D grouping, not Preferences.
...
| ------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------- |
| CPU, CP0, CSR | hex, grouped by B/W/L/D as today                                                                                                                                                                                                                                                               | hex     |
